...
%Este filtro no coincide con el que propone el estandar (se ve mejor en
%tiempo de ejecucion, por cierto).
...
%Calcula la potencia (energia por muestra) de la segnal filtrada
...
%Calcula la ganancia necesaria para que la senal tenga una potencia (en la
%banda de interes) igual a la indicada por el estandar
